; How to run:
; $ z3 problem.smt2
; or if z3 is not installed
; $ docker run -v `pwd`:/tmp/input ghcr.io/z3prover/z3:ubuntu-20.04-bare-z3-sha-8f4ffc7 /tmp/input/problem.smt2

(declare-fun flag () String)
(assert (= flag "TSGLIVE{*** REDACTED ***}")) ; SMT solver will output "sat" when you put correct flag.
